...
const FirstLogin = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Dream Home | Initial Login</title>
            </Helmet>
            <div className="my-12">
                <h2 className="text-3xl font-bold text-center"><span className="text-logoGreen">Hurrah!! </span>You have a registered Profile Now  <br>Please login now</br></h2>
